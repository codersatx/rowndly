...
<ol>
	...
	<li>Click edit and select the Add to Rownds bookmark.</li>
	<li>Click in the url box and delete the current bookmark.</li>
	<li>Paste the code you copied from step 2 into that same box.</li>
	<li>Enjoy.</li>
</ol>
</div>